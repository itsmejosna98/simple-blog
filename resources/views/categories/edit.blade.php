        ...
        <div class="row">
            ...
            @endif
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="post" enctype="multipart/form-data" action="{{ url('category-update') }}">
    {{ csrf_field() }}
<input type="hidden" name="hdn_id" value="{{$id}}">
    <div class="form-group">
        <div class="col-sm-12">
            ...
            <input type="text" required class="form-control" value="{{$categories->name}}" id="category" name="category" value="{{ old('category') }}" placeholder="Add category">
