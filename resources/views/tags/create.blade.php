...
<div class="main-panel">
        ...
        <div class="row">
            ...
            @endif
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="post" enctype="multipart/form-data" action="{{ url('tag-store') }}">
    {{ csrf_field() }}
    ...
    <div class="form-group">
        <div class="col-sm-12">
            ...
            <input type="text" class="form-control" required id="tag" name="tag" value="{{ old('tag') }}" placeholder="Add tag">
            @if ($errors->has('tag'))
